...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-494549b0');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-494549b0');}
...
function clearFlash(){dieView.classList.remove('rl-win-494549b0');dieView.classList.remove('rl-lose-494549b0');if(frameEl){frameEl.classList.remove('rl-win-494549b0');frameEl.classList.remove('rl-lose-494549b0');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-494549b0');if(frameEl){frameEl.classList.add('rl-win-494549b0');}}else{dieView.classList.add('rl-lose-494549b0');if(frameEl){frameEl.classList.add('rl-lose-494549b0');}}
...
var brandEl=document.querySelector('.rl-brand-494549b0');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
